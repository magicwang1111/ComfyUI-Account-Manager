...
app.add_routes(
    [
        web.static("/account-manager/css", CSS_DIR),
        web.static("/account-manager/js", JS_DIR),
        web.static("/account-manager/assets", ASSETS_DIR),
    ]
)
...
if SEPERATE_USERS:
    ...
    access_control.patch_assets()
    app.middlewares.append(access_control.create_view_access_control_middleware())
